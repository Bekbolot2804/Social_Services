...
SECRET_KEY = 'django-insecure-y5@kd#3vf57n#^v998k*=(=97v+co++#x@2-bc26iv3t^7j8!i'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'hob', # Имя вашей БД. Если вы создали черезе psql или IDE свою базу и хотите использовать его - пропишите его имя здесь
        'USER': 'root',
        'PASSWORD': 'mydbpass',
        'HOST': '127.0.0.1',
